...
function addComment(){
  ...
  $('#addComment').empty().append(
    ...
    '<form onsubmit="sendComment()"'+
      ...
      '<input minlength="3" id="name" name="name" placeholder="your name"><br>'+
      '<label for="text-comment">Comment:</label><br>'+
      '<textarea minlength="10" maxlength="1000" id="text-comment" name="text-comment" placeholder="Write something..." rows="4" cols="50">'+
      '</textarea><br><br>'+
